  ...
  return (
    <div>
      <GridContainer>
        ...
        <Link to="user/dO" style={{textDecoration: 'none',display:"block"}}>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <center>
              <img src={Log} style={{width:"20%",height:"20%"}}alt="" srcset=""/>
              <h4 style={{textAlign:"center"}}>Point the camera to the Qr code</h4> 
                <QR/>
                </center>
                <Link to="/manualCode" style={{textDecoration:"none"}}>
