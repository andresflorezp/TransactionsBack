      ...
      <div className={userWrapperClass}>
        ...
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? "" : localStorage.getItem("mailLogged")}
                secondary={
                  <b
                    className={
                      caret +
    ...
    var brand = (
      <div className={logoClasses}>
        <a
          ...
          className={logoMini}
        >
          <img src={logo} alt="logo" style={{width:"50px",height:"50px",paddingBottom:"20px",paddingTop:"3px"}} className={classes.img} />
        </a>
        <a
          href=""
          target="_blank"
